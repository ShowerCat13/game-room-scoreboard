...
|                                                            |
|  +------------------------------------------------------+  |
|  | 1st  [Avatar]  Player Name              2:22.567     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
|  | 2nd  [Avatar]  Player Name              2:24.891     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
|  | 3rd  [Avatar]  Player Name              2:31.044     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
...
|                                                            |
+------------------------------------------------------------+
| [Gear]       Tap to browse  * o o           [QR]           | 56px
+------------------------------------------------------------+
```
...
|  |   [Car]  | |  [Flag]  | | [Party]  | | [Target] |       |
|  +----------+ +----------+ +----------+ +----------+       |
|                                                            |
|  +----------+ +----------+ +----------+ +----------+       |
|  |          | |          | |          | |          |       |
|  | Pinball  | |Platformer| |   RPG    | |  Other   |       | ~180px
|  |[Joystick]| |[Gamepad] | | [Swords] | | [Puzzle] |       |
|  +----------+ +----------+ +----------+ +----------+       |
|                                                            |
+------------------------------------------------------------+
```
...
|                                                            |
|  +------------------------------------------------------+  |
|  | 1st  [Avatar]  Mike                     1:58.234     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
|  | 2nd  [Avatar]  Sarah                    2:01.456     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
|  | 3rd  [Avatar]  Emma                     2:03.789     |  | 72px
|  +------------------------------------------------------+  |
|  +------------------------------------------------------+  |
